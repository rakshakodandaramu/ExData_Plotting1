...
unique(tabfin$Date)
png(file="C:/Course Work/Machine learning/Courseera/R/Course 4/Plot1.png")
hist(as.numeric(tabfin$Global_active_power),col = "red",xlab = "global Active Powers (kilowatts)",main = "Global Active Powers")
dev.off()
